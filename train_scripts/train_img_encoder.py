...
from models import ImageEncoder, EncoderDecoder
...
voxel_encoder_model = EncoderDecoder(embedding_dims).to(device) 
voxel_encoder_model.load_state_dict(torch.load('models/voxel_encoder_decoder_weights_best_val_acc_64.pt'))
voxel_encoder_model.eval()

voxel_encoder = voxel_encoder_model.encoder

model_1 = ImageEncoder(embedding_dims).to(device) 
model_1.load_state_dict(torch.load('models/image_encoder_weights_best_val_acc_64.pt'))
...
voxel_decoder = voxel_encoder_model.decoder
